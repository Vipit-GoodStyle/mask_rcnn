...
def Res101RefineNetStacked(n_classes, inputHeight, inputWidth, nStackNum, loadWeights=False):
    model = build_network_resnet101_stack(inputHeight, inputWidth, n_classes, nStackNum, loadWeights=loadWeights)
    return model
...
def create_global_net(lowlevelFeatures, n_classes):
    ...
    o = (
        Conv2DTranspose(256, kernel_size=(3, 3), strides=(2, 2), name='upsample_16x', activation='relu', padding='same',
    ...
    out2x = Conv2D(n_classes, (1, 1), activation='linear', padding='same', name='out2x', data_format=IMAGE_ORDERING)(
        fup2x)
    out4x = Conv2D(n_classes, (1, 1), activation='linear', padding='same', name='out4x', data_format=IMAGE_ORDERING)(
        fup4x)
    out8x = Conv2D(n_classes, (1, 1), activation='linear', padding='same', name='out8x', data_format=IMAGE_ORDERING)(
        fup8x)
...
def create_refine_net(inputFeatures, n_classes):
    ...
    fup8x = (Conv2DTranspose(128, kernel_size=(3, 3), strides=(2, 2), name='refine8x_deconv_1', padding='same',
                             activation='relu',
                             data_format=IMAGE_ORDERING))(f8x)
    fup8x = (BatchNormalization())(fup8x)

    fup8x = (Conv2DTranspose(128, kernel_size=(3, 3), strides=(2, 2), name='refine8x_deconv_2', padding='same',
                             activation='relu',
                             data_format=IMAGE_ORDERING))(fup8x)
    fup8x = (BatchNormalization())(fup8x)

    # 1 Conv2DTranspose f4x -> fup4x
    fup4x = (Conv2DTranspose(128, kernel_size=(3, 3), strides=(2, 2), name='refine4x_deconv', padding='same',
                             activation='relu',
    ...
    # 1 conv f2x -> fup2x
    fup2x = (Conv2D(128, (3, 3), activation='relu', padding='same', name='refine2x_conv', data_format=IMAGE_ORDERING))(
        f2x)
    ...
    out2x = Conv2D(n_classes, (1, 1), activation='linear', padding='same', name='refine2x', data_format=IMAGE_ORDERING)(
        fconcat)
...
def create_refine_net_bottleneck(inputFeatures, n_classes):
    ...
    # 2 Conv2DTranspose f8x -> fup8x
    fup8x = (Conv2D(256, kernel_size=(1, 1), name='refine8x_1', padding='same', activation='relu',
                    data_format=IMAGE_ORDERING))(f8x)
    fup8x = (BatchNormalization())(fup8x)

    fup8x = (Conv2D(128, kernel_size=(1, 1), name='refine8x_2', padding='same', activation='relu',
                    data_format=IMAGE_ORDERING))(fup8x)
    fup8x = (BatchNormalization())(fup8x)
    ...
    # 1 Conv2DTranspose f4x -> fup4x
    fup4x = (Conv2D(128, kernel_size=(1, 1), name='refine4x', padding='same', activation='relu',
                    data_format=IMAGE_ORDERING))(f4x)
    fup4x = (BatchNormalization())(fup4x)
    fup4x = UpSampling2D((2, 2), data_format=IMAGE_ORDERING)(fup4x)

    # 1 conv f2x -> fup2x
    fup2x = (Conv2D(128, (1, 1), activation='relu', padding='same', name='refine2x_conv', data_format=IMAGE_ORDERING))(
        f2x)
    fup2x = (BatchNormalization())(fup2x)
...
def create_global_net_dilated(lowlevelFeatures, n_classes):
    ...
    o = (Conv2D(256, (3, 3), dilation_rate=(2, 2), activation='relu', padding='same', name='up16x_conv',
                data_format=IMAGE_ORDERING))(o)
    o = (BatchNormalization())(o)
    ...
    o = (
        Conv2DTranspose(256, kernel_size=(3, 3), strides=(2, 2), name='upsample_16x', activation='relu', padding='same',
                        data_format=IMAGE_ORDERING))(o)
    o = (concatenate([o, lf8x], axis=-1))
    o = (Conv2D(128, (3, 3), dilation_rate=(2, 2), activation='relu', padding='same', name='up8x_conv',
                data_format=IMAGE_ORDERING))(o)
    o = (BatchNormalization())(o)
    fup8x = o
    ...
    o = (Conv2DTranspose(128, kernel_size=(3, 3), strides=(2, 2), name='upsample_8x', padding='same', activation='relu',
                         data_format=IMAGE_ORDERING))(o)
    o = (concatenate([o, lf4x], axis=-1))
    o = (Conv2D(64, (3, 3), dilation_rate=(2, 2), activation='relu', padding='same', name='up4x_conv',
                data_format=IMAGE_ORDERING))(o)
    o = (BatchNormalization())(o)
    fup4x = o
    ...
    o = (Conv2DTranspose(64, kernel_size=(3, 3), strides=(2, 2), name='upsample_4x', padding='same', activation='relu',
                         data_format=IMAGE_ORDERING))(o)
    o = (concatenate([o, lf2x], axis=-1))
    o = (Conv2D(64, (3, 3), dilation_rate=(2, 2), activation='relu', padding='same', name='up2x_conv',
                data_format=IMAGE_ORDERING))(o)
    o = (BatchNormalization())(o)
    fup2x = o
...
def build_network_resnet101(inputHeight, inputWidth, n_classes, frozenlayers=True, dilated=False, loadWeights=False):
    input, lf2x, lf4x, lf8x, lf16x = load_backbone_res101net(inputHeight, inputWidth, loadWeights=loadWeights)
...
def build_network_resnet101_stack(inputHeight, inputWidth, n_classes, nStack, loadWeights=False):
    # backbone network
    input, lf2x, lf4x, lf8x, lf16x = load_backbone_res101net(inputHeight, inputWidth, loadWeights=loadWeights)
...
def load_backbone_res101net(inputHeight, inputWidth, loadWeights=False):
